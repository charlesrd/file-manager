...
@section('extra-scripts')
    ...
    {{ Html::script('assets/flot/jquery.flot.crosshair.js') }}
    {{ Html::script('assets/flot/jquery.flot.tooltip.min.js') }}
    {{ Html::script('assets/sparkline/jquery.sparkline.min.js') }}
@stop